...
\begin{table}[!htbp]
  ...
  \begin{tabular}
    ...
    \multicolumn{3}{l}{\textit{\hspace{0.1cm}Spatial/Structural variation}} &        & Control: Area      & 0.039 & 0.194                                                                  & 6                     \\
    Wage Earners                                                            & 0.913  & 0.062              & 32    & Control: Macro Var.                                                    & 0.071 & 0.258 & 11    \\
    Gender: Male                                                            & 0.429  & 0.231              & 129   & \multicolumn{3}{l}{\textit{\hspace{0.1cm}Publication characteristics}} &                       \\
