...
\input{02_Mainmatter/03_Data.tex}
\input{02_Mainmatter/04_Bias.tex}
\input{02_Mainmatter/05_Heterogeneity.tex}
\input{02_Mainmatter/06_BPE.tex}
\input{02_Mainmatter/07_Twins.tex}
...
\input{03_Backmatter/01App_Literature}           			%List of studies
\input{03_Backmatter/03App_BMA}
\input{03_Backmatter/04App_BPE}
%\input{03_Backmatter/05App_twins}
\clearpage
%-----<<< --------- >>>-----
